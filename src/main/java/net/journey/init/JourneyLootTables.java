...
public class JourneyLootTables {
	...
	public static final ResourceLocation TOWER_CHEST_LOCKED_LOOT = register("chests/overworld/tower_dungeon_locked_loot");
	public static final ResourceLocation TOWER_CHEST_LOCKED_LOOT_BASIC = register("chests/overworld/tower_dungeon_locked_loot_basic");
	...
	public static final ResourceLocation CORBANIAN_MOLLUSK = register("mobs/corba/corbanian_mollusk");
