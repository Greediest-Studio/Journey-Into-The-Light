...
public class JourneyBlocks {
	...
	public static JBlockTallGrass eucaTallGrass;
	public static JBlockFlower eucaTallFlowers;
	public static JBlockFlower eucaBlueFlower;

	public static JBlockTallGrass eucaSilverTallGrass;
	public static JBlockFlower eucaSilverGoldFlower;
	public static JBlockTallGrass eucaSilverShortGrass;
	public static JBlockFlower eucaSilverSprouts;
    ...
    public static void init() {
	    ...
	    eucaTallGrass = (JBlockTallGrass) new JBlockTallGrass("eucaTallGrass", "Euca Tall Grass").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
	    eucaTallFlowers = (JBlockFlower) new JBlockFlower("eucaTallFlowers", "Euca Tall Flowers").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
	    eucaBlueFlower = (JBlockFlower) new JBlockFlower("eucaBlueFlower", "Euca Blue Flower").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);

	    eucaSilverTallGrass = (JBlockTallGrass) new JBlockTallGrass("euca_silver_tall_grass", "Silver Tall Grass").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
	    eucaSilverShortGrass = (JBlockTallGrass) new JBlockTallGrass("euca_silver_short_grass", "Silver Short Grass").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
	    eucaSilverGoldFlower = (JBlockFlower) new JBlockFlower("euca_silver_gold_flower", "Gold Flower").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
	    eucaSilverSprouts = (JBlockFlower) new JBlockFlower("euca_silver_sprouts", "Silver Sprouts").setGroundPredicate(GroundPredicate.COMMON_AND_EUCA_GRASS);
