...
public enum JourneyToolMaterial {
    ...
    CRYSTAL_BATTLEAXE(SlayerAPI.addAxeMaterial(3600, 3, 13, 11.25F, 25)),
    ROCKY_BATTLEAXE(SlayerAPI.addAxeMaterial(2600, 3, 13, 10.25F, 25)),
    BACK_BITER(SlayerAPI.addAxeMaterial(1300, 3, 13, 12.5F, 25)),
    DAWN_BREAKER(SlayerAPI.addAxeMaterial(1300, 3, 13, 12.75F, 25)),
    TEMPEST_BATTLEAXE(SlayerAPI.addAxeMaterial(1300, 3, 13, 13, 25)),
    BRONZED_BATTLEAXE(SlayerAPI.addAxeMaterial(1300, 3, 13, 13.5F, 25)),
    STORUM_BATTLEAXE(SlayerAPI.addAxeMaterial(1300, 3, 13, 14.5F, 25)),
    CELESTITE_BATTLEAXE(SlayerAPI.addAxeMaterial(1300, 3, 13, 15.5F, 25)),
