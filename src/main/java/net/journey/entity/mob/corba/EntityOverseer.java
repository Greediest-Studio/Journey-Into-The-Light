...
public class EntityOverseer extends JEntityFlyingMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityOverseer.class, DataSerializers.BOOLEAN);
    ...
    static class AIFireballAttack extends EntityAIBase {
        private final EntityOverseer parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntityOverseer ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityOverseer ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityOverseer ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class LavasnakeMoveHelper extends EntityMoveHelper {
        ...
        public LavasnakeMoveHelper(EntityOverseer ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
