...
public class EntitySurfaceSeer extends JEntityFlyingMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntitySurfaceSeer.class, DataSerializers.BOOLEAN);
    ...
    public static void registerFixesLavasnake(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntitySurfaceSeer.class);
    }
    ...
    public double getEntityMaxHealth() {
        return MobStats.SURFACE_SEER_HEALTH;
    }

    static class AIFireballAttack extends EntityAIBase {
        private final EntitySurfaceSeer parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntitySurfaceSeer ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntitySurfaceSeer ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntitySurfaceSeer ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class LavasnakeMoveHelper extends EntityMoveHelper {
        ...
        public LavasnakeMoveHelper(EntitySurfaceSeer ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
