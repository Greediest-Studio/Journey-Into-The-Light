...
public class EntityDarkener extends JEntityFlyingMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityDarkener.class, DataSerializers.BOOLEAN);
    ...
    public static void registerFixesLavasnake(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityDarkener.class);
    }
    ...
    public double getEntityMaxHealth() {
        return MobStats.DARKENER_HEALTH;
    }

    static class AIFireballAttack extends EntityAIBase {
        private final EntityDarkener parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntityDarkener ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityDarkener ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityDarkener ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class LavasnakeMoveHelper extends EntityMoveHelper {
        ...
        public LavasnakeMoveHelper(EntityDarkener ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
