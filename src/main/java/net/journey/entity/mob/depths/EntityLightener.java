...
public class EntityLightener extends JEntityFlyingMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityLightener.class, DataSerializers.BOOLEAN);
