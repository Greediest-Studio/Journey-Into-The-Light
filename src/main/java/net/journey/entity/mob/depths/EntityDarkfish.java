...
public class EntityDarkfish extends JEntityFlyingMob {

    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.createKey(EntityDarkfish.class, DataSerializers.BOOLEAN);
    ...
    public static void registerFixesLavasnake(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityDarkfish.class);
    }
	...
	public ResourceLocation getLootTable() {
		return JourneyLootTables.DARK_FISH;
	}
    ...
    static class AIFireballAttack extends EntityAIBase {
        private final EntityDarkfish parentEntity;
        public int attackTimer;

        public AIFireballAttack(EntityDarkfish ghast) {
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public AILookAround(EntityDarkfish ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(2);
        }
    ...
    static class AIRandomFly extends EntityAIBase {
        ...
        public AIRandomFly(EntityDarkfish ghast) {
            this.parentEntity = ghast;
            this.setMutexBits(1);
        }
    ...
    static class LavasnakeMoveHelper extends EntityMoveHelper {
        ...
        public LavasnakeMoveHelper(EntityDarkfish ghast) {
            super(ghast);
            this.parentEntity = ghast;
        }
