...
public class EntitySentacoinBag extends Entity {
	...
	public EntitySentacoinBag(World worldIn, double x, double y, double z) {
		super(worldIn);
	...
	public EntitySentacoinBag(World worldIn) {
		super(worldIn);
