...
public class EntityFlameArrow extends EntityArrow implements IProjectile {
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            if (this.isBurning() && !(raytraceresult.entityHit instanceof EntityEnderman) && raytraceresult.entityHit != shootingEntity) {
            ...
            for (int i = 0; i < 20; ++i) {
                this.world.spawnParticle(EnumParticleTypes.FLAME, this.posX + this.motionX * i / 4.0D, this.posY + this.motionY * i / 4.0D, this.posZ + this.motionZ * i / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                this.world.spawnParticle(EnumParticleTypes.LAVA, this.posX + this.motionX * i / 4.0D, this.posY + this.motionY * i / 4.0D, this.posZ + this.motionZ * i / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
